...
const SquareTwo = () => {
  return (
    <div className='flex flex-col p-4 pb-0 gap-4 md:gap-8 md:p-6 rounded-xl shadow-md mx-auto bg-Yellow-500 overflow-hidden h-[240px] md:h-square-md md:w-square-md'>
