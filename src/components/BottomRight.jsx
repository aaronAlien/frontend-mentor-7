...
const BottomRight = () => {
  return (
    <div className='flex flex-col md:flex-row justify-center md:items-center py-4 px-14 md:py-6 md:px-6 gap-6 md:gap-4 lg:h-[250px] 2xl:h-[300px] rounded-xl bg-Purple-500 text-white'>
