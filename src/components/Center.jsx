...
const Center = () => {
  return (
    <div className='flex flex-col mx-auto text-center'>
      <div className='flex flex-col justify-center md:justify-normal w-full mx-auto items-center gap-6 py-8 px-6 md:py-12 md:px-8 bg-Purple-500 text-white rounded-xl md:h-full'>
